...
const outcomeOfHands = (hand0, hand1) => (hand0 + 4 - hand1) % 3
...
const player0Reveal = (g, msg, salt, hand0, outcome) => {
...
const stateUpdate_ = (state, event) => {
