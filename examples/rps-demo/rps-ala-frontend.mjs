/** web3 client frontend for rock-paper-scissors as compiled by Alacrity. */

import {byteToHex, registerInit, hexToAddress, hexTo0x, checkRequirement, kLogError, isEmpty,
        loggedAlert, merge, flip, logErrorK, randomSalt, logging, kLogResult,
        web3, crypto, userAddress,
        saltedDigest, registerBackendHooks,
        registerFrontendHooks, toBN, config, weiToEth, ethToWei,
        getGame, updateGame, dismissGame, removeActiveGame, logGame,
        optionalAddressOf0x, optionalAddressMatches, hexToBigNumber, deployContract,
        queueGame, attemptGameCreation,
        isGameConfirmed, digestHex, sendTx,
        htmlToElement, setNodeBySelector, emptyNode,
...
import * as rac from "./build/rps-ala-contract.js";
import * as backend from "./rps.ala.js";
registerContract(dc.contractAbi, dc.contractFactoryAbi, dc.contractFactoryCode);

//import {registerRpsHooks, MsgType, Outcome, State, outcomeOfHands,
