...
export const decodeState = x => {
    ...
    player1 = optionalAddressOf0x(player1);
...
export const queryState = (contractAddress, blockNumber) => (k, kError = kLogError) =>
    errbacK(rps(contractAddress).query_state.call)({}, blockNumber)(
        x => k(decodeState(x), kError))
// address => KontE(int)
export const queryConfirmedState = contractAddress => (k, kError = kLogError) =>
